...
using WinForm_sales_module.WinForm_sales_module;
...
namespace WinForm_sales_module
{
    public partial class CartForm: Form
    {
        ...
        private readonly IInvoiceService invoiceService = Program.InvoiceService;
        ...
        private void txtsersh_Enter(object sender, EventArgs e)
        {
            if (txtsersh.Text == "Sersh")
            {
                txtsersh.Text = "";
                txtsersh.ForeColor = Color.White;
            }
        }
